...
public class shopPopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_pop);
            ...
            public void onSuccess(int state, Header[] header, byte[] response) {
                try {
                    ...
                    for (int i=0;i<orderResult.length();i++)
                    {
                        ...
                        if (shopPop.containsKey(orderObject.getLong("shop")))
                        shopPop.put(orderObject.getLong("shop"),shopPop.get(orderObject.getLong("shop"))+1);
                        else
                            shopPop.put(orderObject.getLong("shop"),1);
                    }
                    ...
                    if (hasAxes) {
                        ...
                        if (hasAxesNames) {
                            axisX.setName("门店编号");//设置X轴的注释
                            axisY.setName("热度");//设置Y轴的注释
                        }
